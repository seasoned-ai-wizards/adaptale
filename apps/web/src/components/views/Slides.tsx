    ...
    >
      ...
      <section key="my-planet">
        <section
          key="world-2"
          data-auto-animate
          data-background="/theme-world/bg2.jpeg"
        >
        ...
        >
          ...
          >
            <div style={{ flex: "1", padding: "0 20px" }}>
              <p>
                This is Earth. For billions of years, Earth has been our amazing
                home, with just the right temperature for plants, animals, and
                people to thrive.
              </p>
            </div>
            <div
      ...
      <section key="0">
          ...
          >
            <div
              style={{
                ...
                backgroundColor: "#e9e7e6",
                zIndex: "3",
                animation: "bgSlideInFromLeft 1.2s ease-in-out",
              }}
            ></div>
            <h2
              style={{
            ...
            <div
              style={{
                ...
                overflow: "hidden",
                borderRadius: "1.2rem",
                animation: "growWindow 1s ease-in-out",
                zIndex: "3",
              }}
            >
              <img
                ...
                style={{
                  ...
                  minWidth: "90vw",
                  maxHeight: "unset",
                  animation: "imgZoomOut 1s ease-in-out",
                }}
              />
              <div
                style={{
        ...
        <section
          ...
          key="0-1"
          style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "5vw" }}
        >
          <p
          ...
          >
            ADD PRESENTATIONS TO REACT APPS
          </p>
          <p
            className="fragment fade-in-then-semi-out"
            style={{ lineHeight: "0.9" }}
          >
            ADD REACT COMPONENTS TO PRESENTATIONS
          </p>
          <p
            className="fragment fade-in-then-semi-out"
            style={{ lineHeight: "0.9" }}
          >
            MAKE REVEAL PRESENTATIONS EVEN MORE DYNAMIC
          </p>
        </section>
      </section>
      <section key="1">
          ...
          >
            ...
            >
              ...
              <p style={{ textAlign: "left" }}>
                ...
                >
                  This package makes no efforts to impead or restrict what you
                  can or cannot do.
                </span>
                <span
                  className="fragment fade-in-then-semi-out"
                  style={{ marginLeft: "0.35rem", marginRight: "0.35rem" }}
                >
                  You can still add javascript in the usual ways inside and
                  outside the React framework.
                </span>
                <span
                  className="fragment fade-in-then-semi-out"
                  style={{ marginLeft: "0.35rem", marginRight: "0.35rem" }}
        ...
        <section key="1-3" data-auto-animate="" data-background-color="#222222">
          ...
          <p style={{ padding: "1vh 16vw" }}>
            So, if you can make a React component, you can make a Reveal.js
            slide.
          </p>
        </section>
      </section>
