...
const presentationBuilder: AgentConfig = {
  ...
  publicDescription: "Agent that helps you define your presentation outline and manage slides before you go live.",
  instructions:
...
const livePresentationAssistant: AgentConfig = {
  ...
  tools: [
    ...
    },
    {
      ...
      name: "modify_content_on_slide",
      description:
        "Edit the content of an existing slide in real time.",
      parameters: {
        type: "object",
        properties: {
          topicSlug: {
